...
class ItemDict(BaseModel):
    data : Union[List[Item], None] = None
...
@app.post('/cam1')
async def cam1(item_dict: ItemDict):
    # print(item_dict.data)
...
@app.post('/cam2')
async def cam2(item_dict: ItemDict):
...
if __name__ == '__main__':
    uvicorn.run('server_1:app', host='localhost', port=8001, reload=True, log_level='info')
